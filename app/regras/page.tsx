  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-5 pb-24">
        <div className="mb-6">
          <div className="title-stadium text-4xl leading-none">COMO FUNCIONA</div>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-baseline gap-3 flex-wrap">
                  <div
                    className="font-display text-base tracking-[2px]"
                    style={{ color: "var(--text-primary)" }}
                  >
                    {r.titulo}
                  </div>
                  {r.valor && (
                    <div className="font-display text-2xl text-[var(--gold)]">{r.valor}</div>
                  )}
                </div>
                <div
        ...
        <div className="stagger-item mt-4 p-4 bg-green-400/[0.05] border border-green-400/30 rounded-xl flex items-start gap-3">
          ...
          >
            ...
            <br /><br />
            <strong style={{ color: "var(--text-primary)" }}>Resultados editados pelo admin</strong>{" "}
            ficam protegidos: o cron não sobrescreve. Aparecem com escudo dourado 🛡️ no painel admin.
          </div>
        </div>
      </main>
